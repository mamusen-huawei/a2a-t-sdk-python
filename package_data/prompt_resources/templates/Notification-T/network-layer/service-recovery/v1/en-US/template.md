...
4. Access port name. Example: P781-Zhujiang New Town-PTN7900-23-TPA1EG24-17 (required)
...
7. Service recovery plan details (required)
    ...
    Before optimization:
    - Tunnel 1: Tunnel a, source NE: P781-Zhujiang New Town-PTN7900, sink NE: P783-Zhujiang New Town-PTN7900, primary/secondary type: master, status: down, latency: --, packet loss rate: 100%, bandwidth: 10000bps
       - Tunnel route list:
          - Link 1: Link a, source NE: P781-Zhujiang New Town-PTN7900, source port: 23-TPA1EG24-17, sink NE: P782-Zhujiang New Town-PTN7900, sink port: 23-TPA1EG24-17, latency: --
          - Link 2: Link b, source NE: P782-Zhujiang New Town-PTN7900, source port: 23-TPA1EG24-17, sink NE: P783-Zhujiang New Town-PTN7900, sink port: 23-TPA1EG24-17, latency: --
    After optimization:
    - Tunnel 1: Tunnel b, source NE: P881-Zhujiang New Town-PTN7900, sink NE: P883-Zhujiang New Town-PTN7900, primary/secondary type: master, status: up, latency: 20ms, packet loss rate: 0.1%, bandwidth: 10000bps
       - Tunnel route list:
          - Link 1: Link c, source NE: P881-Zhujiang New Town-PTN7900, source port: 25-TPA1EG24-11, sink NE: P882-Zhujiang New Town-PTN7900, sink port: 25-TPA1EG24-12, latency: 10ms
          - Link 2: Link d, source NE: P882-Zhujiang New Town-PTN7900, source port: 25-TPA1EG24-13, sink NE: P883-Zhujiang New Town-PTN7900, sink port: 25-TPA1EG24-14, latency: 15ms
